...
source("causal_discovey/DiffAN/pruning_R_files/train_gam.R", chdir=T)
source("causal_discovey/DiffAN/pruning_R_files/selGam.R", chdir=T)
source("causal_discovey/DiffAN/pruning_R_files/pruning.R", chdir=T)
