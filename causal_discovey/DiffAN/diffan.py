...
from causal_discovey.DiffAN.gaussian_diffusion import GaussianDiffusion, UniformSampler, get_named_beta_schedule, mean_flat, \
                                         LossType, ModelMeanType, ModelVarType
from causal_discovey.DiffAN.pruning import cam_pruning
from causal_discovey.DiffAN.utils import full_DAG
...
class DiffAN():
    ...
    def pruning(self, order, X):
        # Python version CAM (causal additional model)
        # print("order", order)
        # print("DAG", full_DAG(order))
